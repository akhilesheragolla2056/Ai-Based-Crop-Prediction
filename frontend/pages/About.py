...
हमारी टीम वास्तविक खेती चुनौतियों के लिए व्यावहारिक समाधान बनाने के लिए मशीन लर्निंग, कृषि विज्ञान और सॉफ्टवेयर विकास में विशेषज्ञता को जोड़ती है।
    ...
    "te": {
        ...
        "what_is_desc": """
ఫసల్సార్థి (ఫసల్ = పంట, సార్థి = మార్గదర్శకుడు) భారత రైతులకు డేటా ఆధారిత నిర్ణయాలు తీసుకునేందుకు సహాయపడే AI ఆధారిత వ్యవసాయ సలహా వ్యవస్థ.

ఇది నేల, వాతావరణం, మార్కెట్ ధోరణులను విశ్లేషించి ఈ విషయాల్లో సిఫార్సులు ఇస్తుంది:
- **పంట ఎంపిక** – మీ భూమికి సరిపోయే పంటలు
- **ఎరువుల ప్రణాళిక** – సరైన పోషక నిర్వహణ
- **కీటక & రోగ నిర్వహణ** – రక్షణ వ్యూహాలు
- **దిగుబడి అంచనా** – దిగుబడి, ఆదాయం అంచనాలు
- **మార్కెట్ సమాచారం** – ధరలు, డిమాండ్ ధోరణులు
        """,
        "features_title": "ప్రధాన లక్షణాలు",
        "features": [
            ("🌿", "స్మార్ట్ పంట సిఫార్సులు", "నేల, వాతావరణం, మార్కెట్ డేటాతో AI ఆధారిత సిఫార్సులు."),
            ("📊", "మార్కెట్ అవగాహన", "22+ పంటల ధరలు, ధోరణులు, డిమాండ్ విశ్లేషణ."),
            ("💧", "నీటి నిర్వహణ", "పంట అవసరాలకు అనుగుణంగా సాగునీటి షెడ్యూల్."),
            ("🧪", "ఎరువు ప్రణాళిక", "పోషక ఆధారిత సిఫార్సులు, ఆర్గానిక్ ప్రత్యామ్నాయాలు."),
            ("🐛", "కీటక & రోగ నియంత్రణ", "రక్షణ సూచనలు మరియు ముందస్తు హెచ్చరికలు."),
            ("📈", "దిగుబడి అంచనా", "ML ఆధారిత దిగుబడి/ఆదాయం అంచనాలు."),
        ],
        "tech_title": "టెక్నాలజీ స్టాక్",
        "tech_desc": """
- **Machine Learning** – భారతీయ వ్యవసాయ డేటాపై శిక్షణ పొందిన మోడళ్లు
- **Weather** – వాతావరణ సేవల సమీకరణ
- **Market Data** – మార్కెట్ ధరలు, డిమాండ్ విశ్లేషణ
- **Streamlit** – ఆధునిక వెబ్ ఇంటర్‌ఫేస్
- **Python Backend** – దృఢమైన డేటా ప్రాసెసింగ్
        """,
        "crops_title": "మద్దతు పంటలు (22+)",
        "crops_desc": "భారతదేశంలో విస్తారంగా పెంచే పంటలకు మా మోడల్ మద్దతు ఇస్తుంది:",
        "crops_list": [
            "🌾 ధాన్యాలు: బియ్యం, గోధుమ, మొక్కజొన్న",
            "🫘 పప్పుదినుసులు: శనగ, కందులు, మినుములు, పెసలు, అరహర్, రాజ్మా, మొథ్",
            "🍉 పండ్లు: మామిడి, అరటి, ఆపిల్, నారింజ, ద్రాక్ష, బొప్పాయి, దానిమ్మ, తరబూజ, ఖర్భూజ",
            "☕ నగదు పంటలు: పత్తి, జూట్, కాఫీ, కొబ్బరి",
        ],
        "mission_title": "మా లక్ష్యం",
        "mission_desc": """
**"స్థిరమైన, లాభదాయక వ్యవసాయానికి ప్రతి రైతుకి AI ఆధారిత మార్గదర్శనం."**
        """,
        "team_title": "మా టీమ్ గురించి",
        "team_desc": "ఫసల్సార్థి వ్యవసాయ సాంకేతిక కార్యక్రమంలో భాగంగా అభివృద్ధి చేయబడింది.",
        "contact_title": "సంప్రదించండి",
        "contact_desc": "మీ ప్రశ్నలు లేదా అభిప్రాయాలు పంపండి!",
        "language": "భాష",
    },
}
...
def main():
    ...
    with col_lang:
        st.selectbox(
            get_text("language"),
            options=["en", "hi", "te"],
            format_func=lambda x: "English" if x == "en" else ("हिंदी" if x == "hi" else "తెలుగు"),
            key="language",
            label_visibility="collapsed",
        )
