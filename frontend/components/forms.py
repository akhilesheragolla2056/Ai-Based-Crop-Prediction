...
FORM_I18N = {
    "en": {
        ...
        "nitrogen_help": "Essential for leaf growth. Typical range: 0-200.",
        "phosphorus_help": "Important for root and flower development. Typical range: 0-200.",
        "potassium_help": "Aids overall plant health. Typical range: 0-200.",
        "temperature_help": "Average temperature in Celsius.",
        "humidity_help": "Relative humidity percentage.",
    ...
    "hi": {
        ...
        "soil_ph": "मिट्टी pH",
        "regional_caption": "चुने गए मिट्टी प्रकार के लिए मान डेटासेट से लिए गए हैं।",
        ...
        "nitrogen_help": "पत्तियों की वृद्धि के लिए आवश्यक। सामान्य सीमा: 0-200।",
        "phosphorus_help": "जड़ और फूल विकास के लिए महत्वपूर्ण। सामान्य सीमा: 0-200।",
        "potassium_help": "पौधे के स्वास्थ्य के लिए उपयोगी। सामान्य सीमा: 0-200।",
        "temperature_help": "औसत तापमान सेल्सियस में।",
        "humidity_help": "सापेक्ष आर्द्रता प्रतिशत।",
        "rainfall_help": "कुल वर्षा मिलिमीटर में।",
        "soil_ph_help": "मिट्टी pH पोषक उपलब्धता को प्रभावित करता है। 6.5 संतुलित है।",
        "acidic": "3.5 (अम्लीय)",
        "neutral": "6.5 (संतुलित)",
        "alkaline": "9.5 (क्षारीय)",
        "crop_select": "फसल चुनें",
        "leaf_scan": "पत्ती स्कैन",
        "crop_for_diagnosis": "निदान के लिए फसल",
        "upload_leaf_image": "पत्ती छवि अपलोड करें",
        "disease": "रोग",
        "severity": "गंभीरता",
    },
    "te": {
        ...
        "soil_ph": "నేల pH",
        "regional_caption": "ఎంచుకున్న నేల రకానికి విలువలు డేటాసెట్ నుంచి తీసుకోబడ్డాయి.",
        "nitrogen_label": "నైట్రోజన్ (N)",
        "phosphorus_label": "ఫాస్ఫరస్ (P)",
        "potassium_label": "పొటాషియం (K)",
        "temperature_label": "ఉష్ణోగ్రత (C)",
        "humidity_label": "ఆర్ద్రత (%)",
        "rainfall_label": "వర్షపాతం (మిమీ)",
        "nitrogen_help": "ఆకు పెరుగుదలకు అవసరం. సాధారణ పరిధి: 0-200.",
        "phosphorus_help": "వేరు మరియు పుష్ప వికాసానికి ముఖ్యమైనది. సాధారణ పరిధి: 0-200.",
        "potassium_help": "మొక్క ఆరోగ్యానికి ఉపయోగకరం. సాధారణ పరిధి: 0-200.",
        "temperature_help": "సగటు ఉష్ణోగ్రత సెల్సియస్‌లో.",
        "humidity_help": "సాపేక్ష ఆర్ద్రత శాతం.",
        "rainfall_help": "మొత్తం వర్షపాతం మిల్లీమీటర్లలో.",
        "soil_ph_help": "నేల pH పోషకాల లభ్యతను ప్రభావితం చేస్తుంది. 6.5 సంతులితం.",
        "acidic": "3.5 (ఆమ్ల)",
        "neutral": "6.5 (సంతులితం)",
        "alkaline": "9.5 (క్షార)",
        "crop_select": "పంట ఎంచుకోండి",
        "leaf_scan": "ఆకు స్కాన్",
        "crop_for_diagnosis": "నిర్ధారణ కోసం పంట",
        "upload_leaf_image": "ఆకు చిత్రం అప్‌లోడ్ చేయండి",
        "disease": "రోగం",
        "severity": "తీవ్రత",
    },
}
